...
export default function FacultyDashboard() {
  ...
  const fetchData = useCallback(
    async (endpoint, setter) => {
      try {
        const res = await fetch(`${API_URL}/api/faculty/${endpoint}`, {
  ...
  async function handleExcelUpload(e) {
    ...
    try {
      const response = await fetch(`${API_URL}/api/faculty/upload-schedule`, {
        method: "POST",
        headers: { Authorization: `Bearer ${token}` },
        body: formData,
      });
  ...
  async function handlePlanSubmit(e) {
    e.preventDefault();
    try {
      const res = await fetch(`${API_URL}/api/faculty/plans`, {
        method: "POST",
  ...
  async function deletePlan(id) {
    await fetch(`${API_URL}/api/faculty/plans/${id}`, {
      method: "DELETE",
      headers: { Authorization: `Bearer ${token}` },
    });
  ...
  async function handleMarksSubmit(e) {
    e.preventDefault();
    try {
      const res = await fetch(`${API_URL}/api/faculty/marks`, {
        method: "POST",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  async function deleteMarks(id) {
    await fetch(`${API_URL}/api/faculty/marks/${id}`, {
      method: "DELETE",
      headers: { Authorization: `Bearer ${token}` },
    });
  ...
  async function handleAssignmentSubmit(e) {
    e.preventDefault();
    try {
      const res = await fetch(`${API_URL}/api/faculty/assignments`, {
        method: "POST",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  async function deleteAssignment(id) {
    await fetch(`${API_URL}/api/faculty/assignments/${id}`, {
      method: "DELETE",
      headers: { Authorization: `Bearer ${token}` },
    });
